frappe.pages["cmr-pipe-laying-master"].on_page_load = function (wrapper) {
	...
	frappe.call({
		...
		callback: async function (response) {
			try {
				load_css("/assets/cmr_pipe_laying_master/dist/cmr-pipe-laying-master-v13.css");
				await load_script("/assets/cmr_pipe_laying_master/dist/cmr-pipe-laying-master-v13.js");

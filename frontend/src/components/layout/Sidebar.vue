...
const props = defineProps({ activePage: { type: String, required: true }, collapsed: { type: Boolean, default: false }, user: { type: String, required: true }, simpleMasters: { type: Boolean, default: false }, hierarchyMasters: { type: Boolean, default: false } });
defineEmits(["navigate"]);
const search = ref("");
const groups = computed(() => [
  { label: "", items: [["dashboard", "Dashboard", "dashboard"]] },
  { label: "Material Management", items: [["material-inward", "Material Inward", "inward"], ["material-issue", "Material Issue", "issue"], ...(props.hierarchyMasters ? [] : [["material-return", "Material Return", "return"]])] },
  ...
  ...(props.simpleMasters ? [{ label: "Masters & Settings", items: [["master-project", "Project", "project"], ["master-site", "Site", "site"], ...(props.hierarchyMasters ? [["master-zone", "Zone", "setup"], ["master-village", "Village", "site"]] : []), ["master-material", "Item", "item"], ["master-contractor", "Contractor at Site", "contractor"], ["master-supplier", "Supplier / Contractor", "supplier"], ["master-store", "Store", "store"], ["master-attributes", "Material Attributes", "attribute"]] }] : [{ label: "Masters & Settings", items: [["masters", "Master Setup", "setup"], ["master-project", "Project Master", "project"], ["master-site", "Site Master", "site"], ["master-material", "Material Item", "item"], ["master-contractor", "Contractor", "contractor"], ["master-supplier", "Supplier", "supplier"], ["master-store", "Store", "store"], ["master-attributes", "Material Attributes", "attribute"]] }]),
...
<template>
  <aside class="cmr-sidebar" :class="{ collapsed }">
    ...
    <nav class="cmr-navigation" aria-label="Pipe Laying application navigation">
